...
def remain():
	...
	vvvk = getTileMags('ADP.2014-11-12T16:18:02.040.fits')

	vvvj = getTileMags('ADP.2014-11-12T16:17:58.030.fits')
	...
	bt.writeto('vvv_b250.fit',overwrite=True)
...
def main():
	...
	bt.writeto('vvv_2mass_b250.fit',overwrite=True)
	
def calibrate2mass():
	
	plt.close('all')
	
	hdudata = fits.open('vvv_2mass_b250.fit')
	...
	bt.writeto('b250.fit',overwrite=True)
