...
def remain():
	...
	vvvk = getTileMags('ADP.2014-11-12T16:18:35.667.fits')

	vvvj = getTileMags('ADP.2014-11-12T16:18:34.787.fits')
	...
	bt.writeto('vvv_b292.fit',overwrite=True)
...
def main():
	...
	bt.writeto('vvv_2mass_b292.fit',overwrite=True)
	
def calibrate2mass():
	
	plt.close('all')
	
	hdudata = fits.open('vvv_2mass_b292.fit')
	...
	bt.writeto('b292.fit',overwrite=True)
