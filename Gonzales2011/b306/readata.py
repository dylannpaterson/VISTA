...
def remain():
	...
	vvvk = getTileMags('ADP.2014-11-12T16:17:59.163.fits')

	vvvj = getTileMags('ADP.2014-11-12T16:18:55.813.fits')
	...
	bt.writeto('vvv_b306.fit',overwrite=True)
...
def main():
	...
	bt.writeto('vvv_2mass_b306.fit',overwrite=True)
	
def calibrate2mass():
	
	plt.close('all')
	
	hdudata = fits.open('vvv_2mass_b306.fit')
