...
def remain():
	...
	vvvk = getTileMags('ADP.2014-11-12T16:17:44.290.fits')

	vvvj = getTileMags('ADP.2014-11-12T16:18:33.160.fits')
	...
	bt.writeto('vvv_b264.fit',overwrite=True)
...
def main():
	...
	bt.writeto('vvv_2mass_b264.fit',overwrite=True)
	
def calibrate2mass():
	
	plt.close('all')
	
	hdudata = fits.open('vvv_2mass_b264.fit')
	...
	bt.writeto('b264.fit',overwrite=True)
